        ...
        <div class="main-wrapper">
                        ...
                        <div class="hero text-white hero-bg-image" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg">
                            <div class=" hero-inner">
                                <h1>Selamat Datang, <?php
                                                    ...
                                                    echo $data['user']['username'];
                                                    ?>!</h1>
                                <p class="lead">Ini adalah halaman admin, dihalaman ini kamu bisa mengatur akun user dan guru di laman ini kamu bisa mengupdate,read,update,dan delete setiap akun yang terdaftar.</p>
                                <div class="mt-4">
            ...
            <footer class="main-footer">
                <div class="text-center">
                    Copyright &copy; 2024 <div class="bullet"></div><a href="https://github.com/syauqi">Si-Pandai</a>
                </div>
            </footer>
            <!-- End Footer -->
