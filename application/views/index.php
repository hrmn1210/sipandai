		...
		<div class="row">
			<div class="col-md-7 mx-auto">
				<div class="main_title">
					...
					<a href="https://github.com/hrmn1210/project_akhir"><button data-aos="fade-up" data-aos-duration="2400" class="bubbly-button">Download Si-Pandai <span class="lnr lnr-arrow-right"></span></button></a>
				</div>
			</div>
		</div>
	</div>
...
<section class="impress_area p_120">
	<div class="container">
		<div class="impress_inner text-center">
			...
			<p data-aos="fade-up" data-aos-duration="2000">"Untuk Mendaftar Sebagai Guru, Harus Menghubungi Admin untuk pembuatan akun, sistem ini dibuat agar kualitas pembelajaran di web ini tetap terjaga"
			</p>
